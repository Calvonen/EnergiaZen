...
exports.waterDrawDetectionLimits = void 0;
exports.detectsWaterDraw = detectsWaterDraw;
...
exports.waterDrawDetectionLimits = {
    minDropCelsius: 5,
    windowMinutes: 5,
};
...
function detectsWaterDraw(orderedSamples) {
    for (let laterIndex = 1; laterIndex < orderedSamples.length; laterIndex++) {
        ...
        for (let earlierIndex = laterIndex - 1; earlierIndex >= 0; earlierIndex--) {
            ...
            if (minutesApart > exports.waterDrawDetectionLimits.windowMinutes) {
                break;
            }
            if (earlier.inletTemperatureC === null) {
                continue;
            }
            if (earlier.inletTemperatureC - later.inletTemperatureC >=
                exports.waterDrawDetectionLimits.minDropCelsius) {
                return true;
            }
        }
    }
