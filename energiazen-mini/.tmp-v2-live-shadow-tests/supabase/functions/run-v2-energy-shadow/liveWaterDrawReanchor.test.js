...
exports.runLiveWaterDrawReanchorUnitTests = runLiveWaterDrawReanchorUnitTests;
const liveWaterDrawReanchor_1 = require("./liveWaterDrawReanchor");
function assert(condition, message) {
    if (!condition)
        throw new Error(message);
}
function reading(minute, bottomTemp, inletTemp, heating) {
    return {
...
function runLiveWaterDrawReanchorUnitTests() {
    ...
    const ambiguousHeatingResult = (0, liveWaterDrawReanchor_1.resolveLiveDrawReanchors)({
    ...
    const ambiguousThenIdleColdResult = (0, liveWaterDrawReanchor_1.resolveLiveDrawReanchors)({
        coldInletBaselineC: 12.6,
    ...
    const recoveredAndStableResult = (0, liveWaterDrawReanchor_1.resolveLiveDrawReanchors)({
        coldInletBaselineC: 12.6,
    ...
    const drawDuringHeatingResult = (0, liveWaterDrawReanchor_1.resolveLiveDrawReanchors)({
        coldInletBaselineC: 12.6,
    ...
    const heatingWithSampleGapResult = (0, liveWaterDrawReanchor_1.resolveLiveDrawReanchors)({
        coldInletBaselineC: 12.6,
    ...
    const idleDrawResult = (0, liveWaterDrawReanchor_1.resolveLiveDrawReanchors)({
        coldInletBaselineC: 12.6,
        readings: idleDraw,
        reliableDraws: [],
    });
