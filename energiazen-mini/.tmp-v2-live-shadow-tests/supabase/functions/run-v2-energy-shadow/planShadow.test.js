...
exports.runLivePlanShadowUnitTests = runLivePlanShadowUnitTests;
const planShadow_1 = require("./planShadow");
...
function reserve(remainingEnergyKwh, balanceUncertaintyKwh = 0.25, targetEnergyKwh = 6) {
    return {
        available: true,
        reason: null,
        readingCount: 10,
...
function runLivePlanShadowUnitTests() {
    ...
    const healthy = (0, planShadow_1.runLiveEnergyPlanShadow)({
    ...
    const needsHeat = (0, planShadow_1.runLiveEnergyPlanShadow)({
        automaticMaxHeatingHours: 4,
        energyCapacityKwh: 16.864,
        inletBaselineC: 12,
        maxTankTemperatureC: 65,
    ...
    const missingCurrent = (0, planShadow_1.runLiveEnergyPlanShadow)({
        automaticMaxHeatingHours: 4,
        energyCapacityKwh: 16.864,
        inletBaselineC: 12,
        maxTankTemperatureC: 65,
    ...
    const gapped = (0, planShadow_1.runLiveEnergyPlanShadow)({
        automaticMaxHeatingHours: 4,
        energyCapacityKwh: 16.864,
        inletBaselineC: 12,
        maxTankTemperatureC: 65,
    ...
    const capped = (0, planShadow_1.runLiveEnergyPlanShadow)({
    ...
    const lockedAboveConfiguredCap = (0, planShadow_1.runLiveEnergyPlanShadow)({
    ...
    const physicalCapacityBound = (0, planShadow_1.runLiveEnergyPlanShadow)({
        automaticMaxHeatingHours: 1,
        energyCapacityKwh: 10,
        inletBaselineC: 12,
        maxTankTemperatureC: 65,
        now,
        prices: Array.from({ length: 10 }, (_, index) => price(new Date(Date.parse("2026-09-15T05:00:00.000Z") + index * 3600000).toISOString(), index)),
