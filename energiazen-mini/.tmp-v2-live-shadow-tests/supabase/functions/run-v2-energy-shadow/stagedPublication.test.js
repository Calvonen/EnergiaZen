...
exports.runV2StagedPublicationUnitTests = runV2StagedPublicationUnitTests;
const stagedPublication_1 = require("./stagedPublication");
...
function runV2StagedPublicationUnitTests() {
    ...
    const args = (0, stagedPublication_1.buildV2StagedPublicationArgs)({
