// Single source of truth lives in supabase/functions/_shared/energyModelV2/sensorGeometry.ts -
...
export * from "../../supabase/functions/_shared/energyModelV2/sensorGeometry";
