...
export function runEnergyReservePercentUnitTests() {
  ...
  assertClose(reservePercentToKwh(75, capacity as number), 12.648, 0.001, "75 percent target converts to kWh");
  ...
  const ordered = normalizeV2ReservePercents({ targetPercent: 40, safetyPercent: 65 });
