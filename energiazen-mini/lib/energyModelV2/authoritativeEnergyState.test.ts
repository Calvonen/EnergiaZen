...
export function runAuthoritativeEnergyStateUnitTests(){
 ...
 assert(largeLag.quality==="degraded","large sensor lag degrades diagnostics only");assertClose(largeLag.uncertaintyKwh,0,"large sensor lag does not erase physical energy");
}
