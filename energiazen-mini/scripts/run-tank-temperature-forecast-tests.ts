...
import { runHeatingOptimizerSettingsSelectSourceTests } from "../tests/heatingOptimizerSettingsSelectSource.test";
import { runElectricityPriceFetchScheduleMigrationTests } from "../tests/electricityPriceFetchScheduleMigration.test";
...
async function runTests() {
  ...
  runHeatingOptimizerSettingsSelectSourceTests();
