-- get_heating_periods jatti epavarmat (heating = null, esim. Shellyn
-- statuskysely epaonnistui ESP32:lla) lukemat pois range_readings/
-- previous_reading -CTE:ista, mutta data_bounds.latest_reading_at laski
-- edelleen KAIKKIEN lukemien (myos null-tilaisten) uusimman aikaleiman.
-- Avoin (paattymaton) lammitysjakso rajattiin siis tahan aikaleimaan, joten
-- koko UNKNOWN-katkon pituus - vaikka relein todellinen tila ei ollut
-- tiedossa - laskettiin toteutuneeksi 3 kW:n lammitykseksi sahkohistoria-
-- raporteissa (Codex-review, PR #147). data_bounds rajataan nyt samoin kuin
-- muutkin CTE:t vain varmistettuihin (ei-null) lukemiin, jolloin avoin
-- jakso paattyy viimeisimpaan hetkeen jolloin releen tila oikeasti
-- tunnettiin - UNKNOWN-aika ei enaa pidenna jaksoa lainkaan.
