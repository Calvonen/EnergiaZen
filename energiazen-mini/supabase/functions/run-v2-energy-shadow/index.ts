...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const { error: insertError } = await supabase.from("v2_energy_reserve_shadow_runs").insert({
      ...
      comparison: "v1_unavailable", plan_available: validatedHourlyPublicationPlan.available, plan_valid: validatedHourlyPublicationPlan.valid,
      plan_unavailable_reason: validatedHourlyPublicationPlan.available ? null : validatedHourlyPublicationPlan.reason, plan_assumption: validatedHourlyPublicationPlan.assumption,
      forecast_horizon_end_at: validatedHourlyPublicationPlan.forecastHorizonEndAt,
      forecast_standing_loss_kwh_per_hour: validatedHourlyPublicationPlan.standingLossKwhPerHour,
      ...
      forecast_first_target_miss_at: validatedHourlyPublicationPlan.firstTargetMissAt,
      forecast_first_safety_violation_at: validatedHourlyPublicationPlan.firstSafetyViolationAt,
      ...
      plan_total_cost_cents: validatedHourlyPublicationPlan.totalCostCents, plan_candidate_count: validatedHourlyPublicationPlan.candidateCount,
      plan_evaluated_combination_count: validatedHourlyPublicationPlan.evaluatedCombinationCount,
